...
function OnAlliedBarracksCreated(self)
	...
	ExecuteAction("SHOW_MILITARY_CAPTION", "SCRIPT:StartGame", 5)
end
...
function OnReadMeSet(self)
	ExecuteAction("SHOW_MILITARY_CAPTION", "SCRIPT:ReadMeTittle", 10)
end

function  OnGenericUnitStopSet(self)
	ExecuteAction("NAMED_STOP", self)
end
function OnGenericEndToRallyPointSet(self)
	ObjectGrantUpgrade( self, "Upgrade_ObjectDefault" )
end
function OnToggleEnergizedArmor(self)
	ObjectDoSpecialPower(self, "SpecialPower_ToggleEnergizedArmor")
end
function OnUsingSpecialVX(self)
	ExecuteAction("NAMED_USE_COMMANDBUTTON_ABILITY", self, "Command_JAAVT1_Transform")
end

function OnBuildAUnit(self)
	ExecuteAction("NAMED_USE_COMMANDBUTTON_ABILITY", self, "Command_ConstructAlliedAntiAirVehicleTech1")
end
function OnBuildBUnit(self)
	ExecuteAction("NAMED_USE_COMMANDBUTTON_ABILITY", self, "Command_ConstructJapanAntiVehicleVehicleTech1")
end
function OnBuildCUnit(self)
	ExecuteAction("NAMED_USE_COMMANDBUTTON_ABILITY", self, "Command_ConstructSovietAntiVehicleVehicleTech1")
end
function OnBuildDUnit(self)
	ExecuteAction("NAMED_USE_COMMANDBUTTON_ABILITY", self, "Command_ConstructAlliedAntiVehicleVehicleTech1")
end
function OnBuildEUnit(self)
	ExecuteAction("NAMED_USE_COMMANDBUTTON_ABILITY", self, "Command_ConstructJapanAntiVehicleVehicleTech3")
end
function OnBuildFUnit(self)
	ExecuteAction("NAMED_USE_COMMANDBUTTON_ABILITY", self, "Command_ConstructSovietAntiStructureVehicle")
end
function OnBuildGUnit(self)
	ExecuteAction("NAMED_USE_COMMANDBUTTON_ABILITY", self, "Command_ConstructAlliedFighterAircraft")
end
function OnBuildHUnit(self)
	ExecuteAction("NAMED_USE_COMMANDBUTTON_ABILITY", self, "Command_ConstructJapanLightTransportVehicle")
end
function OnBuildIUnit(self)
	ExecuteAction("NAMED_USE_COMMANDBUTTON_ABILITY", self, "Command_ConstructSovietScoutVehicle")
end
function OnBuildJUnit(self)
	ExecuteAction("NAMED_USE_COMMANDBUTTON_ABILITY", self, "Command_ConstructAlliedSupportAircraft")
end
function OnBuildKUnit(self)
	ExecuteAction("NAMED_USE_COMMANDBUTTON_ABILITY", self, "Command_ConstructJapanAntiVehicleInfantryTech3")
end
function OnBuildLUnit(self)
	ExecuteAction("NAMED_USE_COMMANDBUTTON_ABILITY", self, "Command_ConstructSovietAntiGroundAircraft")
end
function OnBuildMUnit(self)
	ExecuteAction("NAMED_USE_COMMANDBUTTON_ABILITY", self, "Command_ConstructSovietBomberAircraft")
end
function OnBuildNUnit(self)
	ExecuteAction("NAMED_USE_COMMANDBUTTON_ABILITY", self, "Command_ConstructJapanCommandoTech1")
end
function OnBuildOUnit(self)
	ExecuteAction("NAMED_USE_COMMANDBUTTON_ABILITY", self, "Command_ConstructAlliedAntiVehicleVehicleTech3")
end
function OnBuildPUnit(self)
	ExecuteAction("NAMED_USE_COMMANDBUTTON_ABILITY", self, "Command_ConstructAlliedAntiNavyShipTech1")
end
function OnBuildQUnit(self)
	ExecuteAction("NAMED_USE_COMMANDBUTTON_ABILITY", self, "Command_ConstructSovietDesolatorInfantry")
end
function OnBuildRUnit(self)
	ExecuteAction("NAMED_USE_COMMANDBUTTON_ABILITY", self, "Command_ConstructAlliedGunshipAircraft")
end
function OnBuildSUnit(self)
	ExecuteAction("NAMED_USE_COMMANDBUTTON_ABILITY", self, "Command_ConstructAlliedAntiAirShip")
end
function OnBuildTUnit(self)
	ExecuteAction("NAMED_USE_COMMANDBUTTON_ABILITY", self, "Command_ConstructSovietAntiAirShip")
end
function OnBuildUUnit(self)
	ExecuteAction("NAMED_USE_COMMANDBUTTON_ABILITY", self, "Command_ConstructSovietSurveyor")
end
function OnBuildVUnit(self)
	ExecuteAction("NAMED_USE_COMMANDBUTTON_ABILITY", self, "Command_ConstructJapanAntiAirVehicleTech1")
end
function OnBuildWUnit(self)
	ExecuteAction("NAMED_USE_COMMANDBUTTON_ABILITY", self, "Command_ConstructJapanSentinelVehicle")
end
function OnBuildXUnit(self)
	ExecuteAction("NAMED_USE_COMMANDBUTTON_ABILITY", self, "Command_ConstructJapanAntiInfantryVehicle")
end
function OnBuildMinerUnit(self)
	ExecuteAction("NAMED_USE_COMMANDBUTTON_ABILITY", self, "Command_ConstructAlliedMiner")
end